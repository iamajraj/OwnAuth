        ...
        <form action="/api/auth/login" method='POST' className="space-y-6">
          <div>
            ...
            <input
              ...
              autoComplete="email"
              required
              className="mt-1 p-3 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md focus:outline-none"
            />
          </div>
          <div>
            <label
            ...
            <div className="mt-1 relative">
              <input
                ...
                required
                className="p-3 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md focus:outline-none"
              />
              <button
                type="button"
